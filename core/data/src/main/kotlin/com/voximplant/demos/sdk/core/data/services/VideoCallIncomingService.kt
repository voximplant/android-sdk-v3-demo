...
class VideoCallIncomingService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val notification = SystemTrayNotifier(applicationContext).createIncomingVideoCallNotification(id, displayName)
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S && exception is ForegroundServiceStartNotAllowedException) {
                Logger.error("VideoCallIncomingService::exception: $exception")
            }
        }
        return START_NOT_STICKY
    }
