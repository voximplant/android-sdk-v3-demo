...
fun MicrophonePermissionDialog(
    ...
    PermissionDialog(
        ...
        title = { Text(text = stringResource(id = R.string.permission_record_audio)) },
        description = { Text(text = stringResource(id = R.string.permission_record_audio_description)) },
    )
}
