...
fun LoginRoute(
    ...
    when (loginError) {
        LoginError.AccountFrozen -> stringResource(com.voximplant.demos.sdk.core.resources.R.string.account_frozen_login_error)
        LoginError.InternalError -> stringResource(com.voximplant.demos.sdk.core.resources.R.string.internal_login_error)
        LoginError.Interrupted -> stringResource(com.voximplant.demos.sdk.core.resources.R.string.interrupted_by_user_error)
        LoginError.InvalidState -> stringResource(com.voximplant.demos.sdk.core.resources.R.string.invalid_state_error)
        LoginError.MauAccessDenied -> stringResource(com.voximplant.demos.sdk.core.resources.R.string.mau_access_denied_error)
        LoginError.NetworkIssue -> stringResource(com.voximplant.demos.sdk.core.resources.R.string.network_issue_error)
        LoginError.TimeOut -> stringResource(com.voximplant.demos.sdk.core.resources.R.string.timeout_error)
        LoginError.TokenExpired -> stringResource(com.voximplant.demos.sdk.core.resources.R.string.token_expired_error)
        else -> null
    }?.let { errorMessage ->
        scope.launch {
